...
train_data = readfile("./Laptops.atepc.train.dat")
test_data = readfile("./Laptops.atepc.test.dat")
...
LABEL_LIST = ["O", "B-ASP", "I-ASP", "[CLS]", "[SEP]"]  # 实体标签
PRETRAINED_BERT_MODEL = "bert-base-uncased"             # 下载的预训练模型
NUM_LABELS = len(LABEL_LIST) + 1                        # 实体标签数（加1是留给padding的）
